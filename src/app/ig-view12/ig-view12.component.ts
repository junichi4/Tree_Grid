...
@Component({
  ...
  templateUrl: './ig-view12.component.html',
  styleUrls: ['./ig-view12.component.scss']
})
export class IgView12Component implements OnInit, OnDestroy {
