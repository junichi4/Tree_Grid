...
@Component({
  ...
  templateUrl: './ig-view13.component.html',
  styleUrls: ['./ig-view13.component.scss']
})
export class IgView13Component implements OnInit, OnDestroy {
